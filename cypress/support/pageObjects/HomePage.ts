...
class HomePage {
  ...
  assertWtwUsHomePage() {
    ...
    genericMethods.assertElementText(
      locators.homepageLocators.countrySelectorMenuLocator,
      this.assertTexts.homePageLocationSelectorText,
    );
  }

  clickOnLocationMenuSelector() {
    genericMethods.clickOnElementMethod(
      locators.homepageLocators.countryLanguageMenuDropdownLocator,
    );
    genericMethods.clickOnElementContainsTextMethod(
      locators.homepageLocators.selectorCountryPageAssertLocator,
      this.assertTexts.countrySelectorLandingAssertText,
    );
  }
